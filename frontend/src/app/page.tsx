          ...
          <div className="space-y-6">
            <div>
              ...
              <nav className="mt-3 space-y-1">
                <a href="#" className="flex items-center gap-3 rounded px-3 py-2 text-sm font-medium text-zinc-500 hover:bg-zinc-900 hover:text-zinc-300 transition-colors">
            ...
            <div>
              ...
              <nav className="mt-3 space-y-1">
                <a href="#" className="flex items-center gap-3 rounded px-3 py-2 text-sm font-bold bg-zinc-900 text-zinc-250 border border-zinc-850">
                  <FolderOpen size={18} className="text-zinc-300" /> Lead Sources
                </a>
                <a href="#" className="flex items-center gap-3 rounded px-3 py-2 text-sm font-medium text-zinc-500 hover:bg-zinc-900 hover:text-zinc-300 transition-colors">
        ...
        <main className="flex-1 p-8">
          <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="text-sm text-zinc-500">Connect, manage, and control all your lead channels from one dashboard.</p>
            </div>
            <button
